    ...
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4" id="contact">
      <div>
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/gauravraw" target="_blank">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/gaurav-ranjan10" target="_blank">
      ...
      <div>
        ...
        >
          <Alert
            ...
            sx={{ width: "100%" }}
          >
            Gaurav has received your message and will get back to you soon!
          </Alert>
        </Snackbar>
        <Snackbar
          open={error}
